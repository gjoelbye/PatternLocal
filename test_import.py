...
def test_imports():
    ...
    try:
        ...
        from pattern_local.simplification import NoSimplification, LowRankSimplification, SuperpixelSimplification
        print('✓ Simplification methods imported successfully')
        
        from pattern_local.solvers import NoSolver, GlobalCovarianceSolver, LocalCovarianceSolver, LassoSolver, RidgeSolver
