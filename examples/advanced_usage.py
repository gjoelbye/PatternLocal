...
def registry_usage_example():
    ...
    try:
        print(f"Available simplification methods: {SimplificationRegistry.list_available()}")
    except:
...
def batch_processing_example():
    ...
    for i, explanation in enumerate(explanations):
        weights_range = (explanation['pattern_weights'].min(), explanation['pattern_weights'].max())
